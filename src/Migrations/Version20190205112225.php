 ...
 */
final class Version20190205112225 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE answers (id INT AUTO_INCREMENT NOT NULL, player_id INT NOT NULL, question VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, answer VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, priority VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, INDEX IDX_50D0C60699E6F5DF (player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
